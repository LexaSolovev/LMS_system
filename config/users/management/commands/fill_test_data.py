...
class Command(BaseCommand):
    ...
    def create_groups(self):
        ...
        all_permissions = list(course_permissions) + list(lesson_permissions) + list(payment_permissions)
    ...
    def create_lessons(self):
        ...
        for lesson_data in lessons_data:
            ...
            if created:
                self.stdout.write(f'   ✅ Создан урок: {lesson.name} ({lesson.course.name})')
            else:
    ...
    def create_payments(self):
        ...
        amounts = [Decimal('1000.00'), Decimal('2500.00'), Decimal('5000.00'), Decimal('7500.00')]
        ...
        for payment_data in payments_data:
            ...
            self.stdout.write(f'   ✅ Создан платеж: {payment.amount} руб. - {payment.user.email}')
